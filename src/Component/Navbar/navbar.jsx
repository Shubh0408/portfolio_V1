      ...
      <Navbar className='bg-gray-800' >
        ...
        <Nav navbar>
          <NavItem className='hidden mr-5 sm:flex gap-4  decoration-transparent'>
            ...
            <NavLink className='text-white' ><a href={resume} download="Shubham_Resume" className='text-white'><button className='bg-gradient-to-r from-cyan-500 to-blue-500 px-2 text-lg rounded-lg hover:cursor-progress font-medium'>Resume</button></a></NavLink>
          </NavItem>
        </Nav>
        <Collapse isOpen={!collapsed} navbar>
          <Nav navbar>
            <NavItem className='ml-9'>
              ...
              <NavLink className='text-white text-center' href="#portfolio"><a href={resume} download="Shubham_Resume" className='text-white no-underline'><div className='bg-gradient-to-r from-cyan-500 to-blue-500 px-2 text-lg rounded-lg hover:cursor-progress font-medium text-center'>Download Resume</div></a></NavLink>
            </NavItem>
