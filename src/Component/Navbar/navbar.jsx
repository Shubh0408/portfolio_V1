      ...
      <Navbar className='bg-gray-800' >
        ...
        <Nav navbar>
          <NavItem className='hidden mr-5 sm:flex gap-4 decoration-transparent'>
            ...
            <NavLink className='text-white' href="https://shubh0408.bio.link" target='blank'>Contact</NavLink>
        ...
        <Collapse isOpen={!collapsed} navbar>
          <Nav navbar>
            ...
            <NavLink className='text-white text-center' href="https://shubh0408.bio.link" target='blank'>Contact</NavLink>
